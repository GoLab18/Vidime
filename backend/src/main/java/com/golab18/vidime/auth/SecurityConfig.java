    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authManager, JwtGenerator jwtGenerator) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/videos/trending").permitAll()
                .requestMatchers("/api/videos/trending/week").permitAll()
                .requestMatchers("/api/videos/best-rated").permitAll()
                .requestMatchers("/api/videos/best-rated/week").permitAll()
                ...
                .requestMatchers("/api/channels/most-viewed").permitAll()
                .requestMatchers("/api/channels/most-viewed/week").permitAll()
                .requestMatchers("/api/channels/most-subscribed").permitAll()
