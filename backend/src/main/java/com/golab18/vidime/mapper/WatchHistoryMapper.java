...
public interface WatchHistoryMapper {
    @Mapping(target = "viewerId", source = "viewer.id")
    ...
    @Mapping(target = "viewer", expression = "java(watchHistoryDto.getViewerId() != null ? new Channel(watchHistoryDto.getViewerId()) : null)")
