...
public interface SubscriptionMapper {
    ...
    @Mapping(target = "subscriber", expression = "java(subscriptionDto.getSubscriberId() != null ? channelMapper.toEntity(subscriptionDto.getSubscriberId()) : null)")
    @Mapping(target = "channel", expression = "java(subscriptionDto.getChannelId() != null ? channelMapper.toEntity(subscriptionDto.getChannelId()) : null)")
